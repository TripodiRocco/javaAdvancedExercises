...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(1, "portiere");
        myFirstMap.put(3, "difensore");
        myFirstMap.put(9, "attaccante");

        // 1c. Print the map
        System.out.println(myFirstMap);

        // 1d. Access an element in the map with .get
        System.out.println(myFirstMap.get(9));
    ...
    private static void exercise2() {
       ...
       for (Map.Entry<String, Double> entry : menuCostsInEuro.entrySet()){
        ...
        System.out.println("Most expensive menu is: " + mostExpensiveMenuItemName);
